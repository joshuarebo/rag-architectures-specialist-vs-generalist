...
Model quality dominated - Generic Claude's superior reasoning outweighed SAC-RAG's document access
Older SAC-RAG was verbose - Claude 3.5 generated longer, less focused responses
Generic Claude's knowledge was current - Had 2023 information despite no retrieval
Table 2 (Both Claude 4.5):
Near-parity achieved - 2.1% gap shows retrieval becomes competitive with strong models
SAC-RAG provided specificity - Cited exact sections and provisions
Generic Claude demonstrated breadth - Strong general legal knowledge
Trade-off emerged - SAC-RAG won on statutory detail, Generic Claude on reasoning clarity
Thesis Implication:
